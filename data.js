...
export const mockPosts = [
    {
        id: 1,
        title: "How I built a $5K/mo SaaS in 30 days and sold it",
        type: "success",
    ...
    {
        id: 2,
        title: "Spent $10k on Facebook Ads for a Dropshipping store, made $0",
        type: "fail",
    ...
    {
        id: 3,
        title: "Design agency to $20k/mo: The power of cold DMs",
        type: "success",
        skills: ['design', 'sales'],
    ...
    {
        id: 4,
        title: "My Newsletter failed after 6 months of writing",
        type: "fail",
    ...
    {
        id: 5,
        title: "Bootstrapped a dev agency to $1M ARR",
        type: "success",
